<H1 align="center">Nlauncher</H1>

<img src="https://github.com/AYNDroid/NLauncher/blob/v3_openjdk/app_pojavlauncher/src/main/assets/pojavlauncher.png" align="left" width="150" height="150" alt="MojoLauncher logo">

[![Android CI](https://github.com/AYNDroid/NLauncher/workflows/Android%20CI/badge.svg)](https://github.com/MojoLauncher/MojoLauncher/actions)

* NLauncher is a launcher, based on [PojavLauncher](https://github.com/PojavLauncherTeam/PojavLauncher), that allows you to play Minecraft: Java Edition on your Android device!
...
- [Getting NLauncher](#getting-mojolauncher)
- [Building](#building) 
...
## Introduction 
* Nlauncher is a Minecraft: Java Edition launcher for Android based on [PojavLauncher](https://github.com/PojavLauncherTeam/PojavLauncher)
* This launcher can launch almost all available Minecraft versions ranging from rd-132211 to 1.21 snapshots (including Combat Test versions). 
* Modding via Forge and Fabric are also supported. 

## Getting NLauncher

You can get Nlauncher via two methods:

1. You can get the prebuilt app from [automatic builds](https://github.com/AYNDroid/NLauncher/actions).
